...
function check() {
    ...
    const bundeslandInfo = document.getElementById("bundeslandInfoErgebnis");
    ...
    switch (bundesland) {
        ...
        case "Thüringen":
            ...
            break;
        default:
            bundeslandInfoErgebnis.innerText = "Ein solches Bundesland gibt es in Deutschland nicht.";
    }
}